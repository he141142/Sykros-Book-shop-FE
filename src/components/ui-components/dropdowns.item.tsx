...
export default class DropDownItem extends PureComponent<GenresDto, any> {

    constructor(props: GenresDto) {
        super(props);
        this.state = {
            name: 'Link',
            count: 1,
    ...
    constructGridLayout = (amountOneCol: number): any[][] => {
        ...
        let resp: Array<Array<any>> = this.props.subGenresName.reduce<Array<Array<string>>>((acc, item, index, arr) => {
            subArr.push(item);
